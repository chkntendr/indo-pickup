            ...
            <div class="bg-light rounded h-100 p-4">
                <form action="/client/post" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="kode" class="form-control" id="kode" aria-describedby="text">
                    </div>
                    <div class="mb-3">
                        <label for="client" class="form-label">Nama Client</label>
                        <input type="text" name="client" class="form-control" id="client" aria-describedby="text">
                    </div>
